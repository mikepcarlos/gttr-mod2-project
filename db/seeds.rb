...
Clothe.create(name: "V-Neck" , category: "Shirts", color: "Red")
Clothe.create(name: "Little Black Dress" , category: "Dress", color: "Black")
Clothe.create(name: "Superhero" , category: "Latex Suit", color: "Red")
Clothe.create(name: "Boy's Dress" , category: "Dress", color: "Blue")
Clothe.create(name: "Leather Gloves" , category: "Accessories", color: "Red")
Clothe.create(name: "Heels" , category: "Footwear", color: "Yellow")
Clothe.create(name: "Sun Hat" , category: "Accessories", color: "Orange")
Clothe.create(name: "Joggers" , category: "Pants", color: "Green")
Clothe.create(name: "Button-Down" , category: "Shirts", color: "White")
